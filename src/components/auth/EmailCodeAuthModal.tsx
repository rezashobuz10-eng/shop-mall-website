  ...
  const handleAutoFill = () => {
    if (activeCode && activeCode.length === 6) {
      ...
      addToast({
        type: 'info',
        title: 'Code Filled',
        message: `Filled 6-digit code: ${activeCode}`
      });
    }
  };
        ...
        <div className="p-6">
          ...
          {step === 'input_email' ? (
            ...
            <form onSubmit={handleVerify} className="space-y-5">
              ...
              {activeCode && (
                <div className="p-3 bg-linear-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl space-y-2 text-xs animate-in slide-in-from-top-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5 text-blue-800 font-bold text-[11px]">
                      <Mail className="w-3.5 h-3.5 text-blue-600" />
                      <span>📩 Incoming Email Preview (Inbox):</span>
                    </div>
                    <span className="text-[10px] text-emerald-700 font-bold bg-emerald-100 px-1.5 py-0.5 rounded-full">
                      Delivered
                    </span>
                  </div>

                  <div className="flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-blue-200/80">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-2 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 text-[10px] font-bold rounded-lg flex items-center gap-1 cursor-pointer transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-bold rounded-lg flex items-center gap-1 cursor-pointer shadow-2xs"
                      >
